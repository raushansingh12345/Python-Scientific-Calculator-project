...
while True:
    ...
    if choice=='a':
        ...
        num2= input("Num2: ")
        if num1.isalpha():
            print("invalid input!\n Please write numbers which you want to substract")
        else:
            x=eval(num1)
            y=eval(num2)
            print("Subtraction of Entered Number is: ",x-y)
    elif choice=='m':
        ...
        numerator=eval(input("Numerator: "))
        denominator=eval(input("Denominator: "))
        print("mod(%) of Entered Number is: ",numerator%denominator)
    elif choice=='sq':
